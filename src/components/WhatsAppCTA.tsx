...
const WhatsAppCTA: React.FC<WhatsAppCTAProps> = ({
  message = "שלום! אני מעוניין לקבל מידע על השירותים שלכם",
}) => {
  ...
  return (
    <>
      ...
      >
        ...
        {/* Tooltip */}
        <div
          className={`absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-1 bg-gray-800 text-white text-sm rounded-lg whitespace-nowrap transition-opacity duration-200 ${
