        ...
        <div className="flex justify-between items-center h-20 py-2">
          ...
          <div className="md:hidden flex items-center space-x-3 space-x-reverse">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-2 rounded-xl bg-gold text-white hover:bg-gold/90 transition-all duration-200"
              aria-label="צור קשר ב-WhatsApp"
            >
            ...
            <button
              ...
              className="inline-flex items-center justify-center p-2 rounded-xl text-ink hover:text-gold hover:bg-gold/5 transition-all duration-200"
            ...
            <div className="px-4 pt-3 pb-4 space-y-1">
              {navigation.map((item) => (
                <Link
                  key={item.name}
                  href={item.href}
                  className={`block px-3 py-2 rounded-lg text-body font-medium transition-all duration-200 ${
                    isActive(item.href)
                      ? "text-gold bg-gold/10"
                      : "text-ink hover:text-gold hover:bg-gold/5"
                  }`}
